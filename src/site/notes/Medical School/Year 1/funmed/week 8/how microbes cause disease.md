...
# Adherence
- pathogens express multiple adhesion factors
- adherence prevents early clearance from host, enabling competition with natural flora

## Major Adhesion Factors
- pili or fimbriae
	- hair-like structures made of proteins
- afimbril adhesin
	- membrane-anchored proteins interacting directly with host receptors
	- indirect interaction with host cell receptors via bridging molecule

## Biofilms in Adhesion
- community of bacteria that produce a sugar polymer, known as extrapolymeric substance (EPS) that allows the biofilm to attach to a surface
- extreme resistance to antibiotics and other anti-microbial agents
- high resistance to host immune cells
![how microbes cause disease-20241113111324098.png](/img/user/Medical%20School/Year%201/funmed/week%208/attachments/how%20microbes%20cause%20disease-20241113111324098.png)

# Local Spread and Invasion
## Local Spread
- once on epithelium, can spread via the blood stream
- degradative enzymes called spreading facotrs
	- formation of lesions at site of colonisation and facilitate growth
	- do not kill host cells
		- hyaluronidase breaks down hyaluronic acid in connective tissue
		- collegenase 
## Invasion
### Trigger
- bacteria inject virulence factors into host cell cytoplasm
- bacteria weakly adhere to cell
- force the cell to engulf the bacterium
### Zipper
- pathogen surface protein has a high affinity with host cell transmembrane protein
- host cell envelops pathogen --> uptake of pathogen
...
- escape from phago/endosome and grow in cytoplasm
- inhibition of phagosome-lysosome fusion
- survive within phagolysosome (inhibition of reactive species)
- replicate within phagolysosome
### Destroying Antibodies
- IgA proteases cleave IgA
	- natural mucosal antibody which decreases rate of colonisation
## Survive Stress
- detoxification of oxygen derived harmful substances from the host
- superoxide dismutase (SOD) neutralise O<sub>2</sub><sup>-</sup> free radicals

## Nutrients
- iron chelating agents have a high affinity for Fe
- iron is required for microorganism growth
# Immune Response
## Complement
...
## Phagolysosome
- antimicrobials lysosomal enzymes: cationic peptides - α-defensins
...
- 3 main types
	- cytolysins with cell membrane targets
	- bipartite A-B toxins: intracellular targets
	- toxins acting on host defences (superantigens)

### A-B exotoxins
- two subunits - A and B
	- A is active domain (enzymatic activity)
	- B is binding domain (allows translocation of A into cytoplasm)
#### Cholera Toxin
- ADP ribosylates large G proteins which regulate cAMP
...
![how microbes cause disease-20241113113929981.png](/img/user/Medical%20School/Year%201/funmed/week%208/attachments/how%20microbes%20cause%20disease-20241113113929981.png)
